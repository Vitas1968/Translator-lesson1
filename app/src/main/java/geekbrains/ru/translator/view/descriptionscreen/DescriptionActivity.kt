...
class DescriptionActivity : AppCompatActivity() {
    ...
    private fun setData() {
        ...
        val bundle = intent.extras?.apply {
            description_header.text = getString(WORD_EXTRA)
            description_textview.text = getString(DESCRIPTION_EXTRA)
            imageLink=getString(URL_EXTRA)
        }
